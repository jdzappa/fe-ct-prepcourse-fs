...
function todosIguales(array) {
   ...
   // Tu código:
   var cumplenCondicion = array.every(elemento => elemento === array[0]);
...
function mesesDelAño(array) {
   ...
   // Tu código:
   var existen = array.includes("Enero", "Marzo", "Noviembre");
   if (existen === false) {
...
function tablaDelSeis() {
   ...
   while (multiplicador <= 10) {
      tabladelseis.push(6 * multiplicador);
      multiplicador++;
   }
   return tabladelseis;
}
